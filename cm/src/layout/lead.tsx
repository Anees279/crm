...
export const Lead = () => {
  ...
  const fetchLeads = async () => {
    try {
      const response = await axios.get('https://crm-eight-pied.vercel.app/api/leads');
  ...
  const handleAddLead = async (e: React.FormEvent) => {
    ...
    if (
      ...
      try {
        const response = await axios.post('https://crm-eight-pied.vercel.app/api/leads', newLead);
  ...
  const handleDeleteLead = async (id: string) => {
    try {
      await axios.delete(`https://crm-eight-pied.vercel.app/api/leads/${id}`);
